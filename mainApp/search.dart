...
import 'package:demoapp/src/article.dart';
...
import 'package:demoapp/src/widgets/headline.dart';
import 'package:demoapp/src/widgets/hn_page.dart';
import 'package:demoapp/src/widgets/loading_info.dart';
import 'package:demoapp/src/widgets/search.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Headline(
          text: 'Найти навык',//tabs[_currentIndex].name,
          index: _currentIndex,
        ),
        elevation: 0.0,
        actions: [
